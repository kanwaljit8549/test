		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Sprint1_Temp App",
									"targetURL": "#gwsp1tempproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"gwsp1tempproject-display": {
								"semanticObject": "gwsp1tempproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=gwsp1tempproject",
									"url": sap.ui.require.toUrl("gwsp1tempproject")
								}
							}
						}
					}
